...
export default function App() {
  ...
  return (
    <div className="bg-gradiant-r from-orange-500 to-blue-700">
        ...
        <div className="flex justify-items-between gap-7 p-6 cursor-pointer">
          <nav>
            <ul className="flex flex-col font-bold text-bold p-10 gap-7 bg-gray-100">
              <li
                className={currentPage === "dashboard" ? pageStyle : pointer}
              ...
              <li
                className={currentPage === "student" ? pageStyle : pointer}
              ...
              <li
                className={currentPage === "courses" ? pageStyle : pointer}
